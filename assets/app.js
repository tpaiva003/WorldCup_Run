...
const I18N = {
  pt: {
    ...
    goalsUnit: "GOLOS",
    goalsSub: "= KM PARA COMPLETAR, CADA UM",
    record: "🏆 O MUNDIAL COM MAIS GOLOS DE SEMPRE",
    ...
    noData: "SEM DADOS",
    stateSoon: "EM BREVE",
    stateOnTrack: "COMPLETO",
    stateBehind: "A CAMINHO",
    justNow: "agora mesmo",
    minAgo: "há {n} min",
    hAgo: "há {n} h",
    run: "Corrida",
  ...
  en: {
    ...
    goalsUnit: "GOALS",
    goalsSub: "= KM TO COMPLETE, EACH",
    record: "🏆 THE HIGHEST-SCORING WORLD CUP EVER",
